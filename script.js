...
var num_moves = 0, totalmoves = 50;
var seconds = 0;
var empty_index = 8, current_index = 0;
...
//var squares = '371248659';
var squares = '182943765';
  ...
  function createGrid() {
    for (x in squares) {
      if (x <= 2) {
        ...
        if (squares[x] != '9') $(".row1").append('<div class="tile" id="square-' + squares[x] + '"></div>');
        else {
        ...
        // $(".image-grid").append('<div class="tile" id="square-'+squares[x]+'"></div>');
        if (squares[x] != '9') $(".row2").append('<div class="tile" id="square-' + squares[x] + '"></div>');
        else {
        ...
        // $(".image-grid").append('<div class="tile" id="square-'+squares[x]+'"></div>');
        if (squares[x] != '9') $(".row3").append('<div class="tile" id="square-' + squares[x] + '"></div>');
        else {
  ...
  function imageClick() {
    $(".tile, .empty").click(function () {
      if (seconds > 0 && !checkWin()) {
        ...
        else if ((current_index - 3 >= 0 ? tiles[current_index - 3].is(empty_tile) : false)) {
          swapEmptyTile(current_tile, empty_index, current_index);
          whenWin();
        }
        else if ((current_index + 3 <= 8 ? tiles[current_index + 3].is(empty_tile) : false)) {
          swapEmptyTile(current_tile, empty_index, current_index);
          whenWin();
        }
        else {
