...
var squares = [13,2,10,3,1,12,8,4,5,16,9,6,15,14,11,7];
  ...
  function createGrid() {
    for (x in squares) {
      if (x <= 3) {
        ...
        if (squares[x] != '16') $(".row1").append('<div class="tile" id="square-' + squares[x] + '"></div>');
        else {
        ...
        // $(".image-grid").append('<div class="tile" id="square-'+squares[x]+'"></div>');
        if (squares[x] != '16') $(".row2").append('<div class="tile" id="square-' + squares[x] + '"></div>');
        else {
        ...
        // $(".image-grid").append('<div class="tile" id="square-'+squares[x]+'"></div>');
        if (squares[x] != '16') $(".row3").append('<div class="tile" id="square-' + squares[x] + '"></div>');
        else {
        ...
        // $(".image-grid").append('<div class="tile" id="square-'+squares[x]+'"></div>');
        if (squares[x] != '16') $(".row4").append('<div class="tile" id="square-' + squares[x] + '"></div>');
        else {
  ...
  function imageClick() {
    $(".tile, .empty").click(function () {
      if (seconds > 0 && !checkWin()) {
        ...
        else if ((current_index - 4 >= 0 ? tiles[current_index -4].is(empty_tile) : false)) {
          swapEmptyTile(current_tile, empty_index, current_index);
          whenWin();
        }
        else if ((current_index + 4 <= 16 ? tiles[current_index + 4].is(empty_tile) : false)) {
          swapEmptyTile(current_tile, empty_index, current_index);
          whenWin();
        }
        else {
